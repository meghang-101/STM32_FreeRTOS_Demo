...
/* Private user code ---------------------------------------------------------*/
/* USER CODE BEGIN 0 */
char *data = "Hello from Aviral Gupta\n";
/* USER CODE END 0 */
...
/* USER CODE BEGIN Header_led1blink */
/**
...
/* USER CODE BEGIN Header_usbcomm_func */
/**
* @brief Function implementing the usbcomm thread.
* @param argument: Not used
* @retval None
*/
